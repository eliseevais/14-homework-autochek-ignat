...
function Clock() {
  ...
  // можно подсунуть в локалСторэдж нужную дату, чтоб увидеть как она отображается
  ...
  // const stringDate = 'date->date' || <br/> // день.месяц.год (01.02.2022)
    ...
    <div className={s.clock}>
      ...
      <div className={s.buttonsContainer}>
        ...
        <SuperButton
          ...
          // пишут студенты, задизэйблить если таймер не запущен
          onClick={stop}
        >
          stop
        </SuperButton>
